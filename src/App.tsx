  ...
  return (
    <>
      ...
      <main className="flex w-screen flex-col items-center justify-center bg-[#60CDFF] px-4 py-8 xl:py-[73px]">
        ...
        <div className="mt-3 flex items-center text-[28px] font-bold leading-[32px] text-black md:text-6xl xl:mt-2 xl:text-[72px] xl:leading-[88px]">
          ...
          <Typewriter
            options={{
              ...
              cursorClassName: "Typewriter__cursor text-[#012994] ml-2",
              loop: true,
              cursor: "▍",
            }}
            onInit={(typewriter) => {
        ...
        <div className="mt-3 text-base font-medium text-black xl:text-2xl xl:font-bold">
        ...
        <div className="mt-3 text-sm font-medium text-black sm:font-bold md:text-base xl:text-2xl">
      ...
      >
        <div className="flex w-auto flex-col justify-start xl:w-[410px]">
        ...
        <div className="relative mt-8 flex flex-col items-center justify-center rounded-[20px] border-2 border-black bg-white px-[46px] py-8 md:mr-[360px] xl:ml-6 xl:mr-0 xl:px-[56px] xl:py-[44px] 2xl:ml-[190px] 2xl:mt-0">
      ...
      >
        <img
          ...
          alt=""
        />
        <div className="mb-8 mt-12 flex w-auto flex-col justify-start text-center sm:text-left md:mb-16 xl:-mt-20 xl:mb-0 2xl:w-[437px]">
          <div className="text-2xl font-bold text-white md:text-[68px] md:leading-[80px] xl:font-semibold">
            Auto-strategies
          </div>
          <div className="mt-2 w-auto text-base font-medium text-white sm:mt-[44px] sm:text-[18px] sm:font-normal sm:leading-[28px] md:w-4/5">
      ...
      <main className="flex w-screen items-center justify-center bg-white px-4 py-6 xl:px-[88px] xl:py-[120px]">
        ...
        >
          ...
          <div className="mt-8 text-2xl font-bold text-white sm:mt-4 sm:text-[52px] sm:font-semibold sm:leading-[72px]">
            Risk isolated by market
          </div>
          <div className="mt-1 text-sm font-medium text-white sm:text-base sm:leading-[24px]">
